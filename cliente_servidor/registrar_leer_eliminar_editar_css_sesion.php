...
<div class="form-container">
    <h2 class="form-title"><?php echo $editar_usuario ? "Editar Usuario" : "Formulario de Registro"; ?></h2>
        <form action="registrar_leer_eliminar_editar_css.php" method="post">
            ...
            <div class="form-actions">
                ...
                <?php if ($editar_usuario): ?>
                    <a href="registrar_leer_eliminar_editar_css.php" class="cancel-btn">Cancelar</a>
                <?php endif; ?>
            </div>
        </form>
</div>
                ...
                <tr>
                    ...
                    <td>
                        <form method="post" onsubmit="return confirm('¿Eliminar este usuario?');">
                            ...
                            <input type="submit" class="danger-color" value="Eliminar">
                        </form>
                        <form method="post">
                            <input type="hidden" name="editar_id" value="<?php echo $row['id']; ?>">
                            <input type="submit" class="action-btn btn-edit" value="Editar">
                        </form>
                    </td>
                </tr>
            <?php endwhile; ?>
